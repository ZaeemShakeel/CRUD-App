  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center gap-5 min-h-screen">
        <h2 className="font-bold text-3xl">CRUD App with Redux</h2>
        <Link
          to="/create"
          type="button"
                ...
                <>
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      ...
                      <button
                        type="button"
                        className="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br hover:ring-4 hover:outline-none hover:ring-red-300 dark:hover:ring-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 cursor-pointer"
                      >
                        Delete
                      </button>
                    </td>
